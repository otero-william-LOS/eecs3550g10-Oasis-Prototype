...
public class BllchrgDriver implements DataDriver {
    ...
    public static ArrayList<BllchrgModel> searchByDateCharged(BllchrgModel DateCharged){
     ...
     public List<BllchrgModel> rtrnAllBllChrgs() {
         return devDB.retrieveAllBllchrgs();
     }
     public List<BllchrgModel> rtrnAllPaidChrgs() {
         return devDB.retrieveAllPaidchrgs();
     }
     public List<BllchrgModel> rtrnAllUnpaidChrgs() {
    ...
    // asignRsvToBllchrg
    public void asignRsvToBllchrg(BllchrgModel bllchrgID , RsvModel rsv){
        bllchrgID.setRsv(rsv);
    }
